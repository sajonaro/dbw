...
![A PRQL query](docs/images/prql-example.svg)
...
- Open `packages/extension` in VS Code and press F5 to launch an Extension
  Development Host.
- Adding a database is a new package: see [CONTRIBUTING.md](CONTRIBUTING.md), and
  [ARCHITECTURE.md](ARCHITECTURE.md) for how the parts fit.
